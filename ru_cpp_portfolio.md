    ...
    <tbody>
        <tr>
            <td>
             ...
             <td> Smedium </td>
             <td>Работает нормально, но выглядит все хаотично - это надо исправить</td>
             <td> Нет </td>
        </tr>
        <tr>
            <td>
             ...
             <td> Small </td>
             <td>Запускается и работает. Движок поддерживает возведение в степень, но забыл добавить ее в интерфейс. В целом нужен более удобный CLI-интерфейс</td>
             <td> No Context </td>
        </tr>
        <tr>
            <td>
